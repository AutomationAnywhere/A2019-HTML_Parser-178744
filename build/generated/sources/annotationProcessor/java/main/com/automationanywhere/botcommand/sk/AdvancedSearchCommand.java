...
public final class AdvancedSearchCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(AdvancedSearchCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    AdvancedSearch command = new AdvancedSearch();
    ...
    if(parameters.containsKey("attrname") && parameters.get("attrname") != null && parameters.get("attrname").get() != null) {
      convertedParameters.put("attrname", parameters.get("attrname").get());
      if(!(convertedParameters.get("attrname") instanceof String)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","attrname", "String", parameters.get("attrname").get().getClass().getSimpleName()));
      }
    }
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("html"),(String)convertedParameters.get("query"),(String)convertedParameters.get("attrname"),(String)convertedParameters.get("searchtype")));
